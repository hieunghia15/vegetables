@extends('admin.layout',[ 'title' => __($title ?? 'Danh sách nông dân bị khóa')])
@section('main')
                    ...
                    <div class="nk-block-between">
                        <div class="nk-block-head-content">
                            <h3 class="nk-block-title page-title">
                                ...
                                <span><a href="" class="active">Nông dân bị khóa</a></span>
                            </h3>
                        </div>
                        <div class="nk-block-head-content">
                    ...
                    <div class="row g-gs">
                            ...
                            <div class="card card-bordered product-card">
                                <div class="product-thumb">
                                    <a href="html/product-details.html">
                                        <img class="card-img-top" src="../image/farmer/Hà Thị Liên.png"
                                            alt="Hà Thị Liên">
                                    </a>
                                </div>
                                <div class="card-inner text-center">
                                    <h5 class="product-title"><a href="html/product-details.html">Hà Thị Liên</a>
                                    </h5>
                        ...
                        <div class="col-xxl-3 col-lg-4 col-sm-6">
                            <div class="card card-bordered product-card">
                                <div class="product-thumb">
                                    <a href="html/product-details.html">
                                        <img class="card-img-top" src="../image/farmer/Huỳnh Văn Ơn.png"
                                            alt="Huỳnh Văn Ơn">
                                    </a>
                                </div>
                                <div class="card-inner text-center">
                                    <h5 class="product-title"><a href="html/product-details.html">Huỳnh Văn Ơn</a>
                                    </h5>
                                    <ul class="product-actions">
                                        <li><a href="#"><em class="icon ni ni-edit"></em></a></li>
                                        <li><a href="#"><em class="icon ni ni-eye"></em></a></li>
                        ...
                        <div class="col-xxl-3 col-lg-4 col-sm-6">
                            <div class="card card-bordered product-card">
                                <div class="product-thumb">
                                    <a href="html/product-details.html">
                                        <img class="card-img-top" src="../image/farmer/Trình Thị Linh.png"
                                            alt="Trình Thị Linh">
                                    </a>
                                </div>
                                <div class="card-inner text-center">
                                    <h5 class="product-title"><a href="html/product-details.html">Trình Thị Linh</a>
                                    </h5>
                                    <ul class="product-actions">
                                        <li><a href="#"><em class="icon ni ni-edit"></em></a></li>
                                        <li><a href="#"><em class="icon ni ni-eye"></em></a></li>
