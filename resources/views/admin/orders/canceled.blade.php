@extends('admin.layout',[ 'title' => __($title ?? 'Đơn đã hủy')])
@section('main')
                    ...
                    <div class="nk-block-head nk-block-head-sm">
                        <div class="nk-block-between">
                            <div class="nk-block-head-content">
                                <h3 class="nk-block-title page-title">Đơn đặt hàng đã hủy</h3>
                    ...
                    <div class="nk-block">
                        <div class="nk-tb-list is-separate is-medium mb-3">
                            <div class="nk-tb-item nk-tb-head">
                                ...
                                <div class="nk-tb-col"><span>Tổng</span></div>
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right">
                                                        <ul class="link-list-opt no-bdr">
                                                            <li><a href="{{route('admin.orders.show',['id'=>$order->id])}}">
                                                                <em class="icon ni ni-eye"></em><span>Chi tiết đơn hàng</span>
                                                            </a></li>
