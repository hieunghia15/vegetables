@extends('admin.layout',[ 'title' => __($title ?? 'Tạo vai trò')])
@section('main')
                ...
                <div class="nk-block-head nk-block-head-sm">
                    <div class="nk-block-between">
                        <div class="nk-block-head-content">
                            <h3 class="nk-block-title page-title">Tạo vai trò</h3>
                    ...
                    <div class="card card-bordered">
                        <div class="card-inner-group">
                            <div class="card-inner p-0">
                                ...
                                <form method="POST" action="{{route('admin.permissions.store-role')}}" enctype="multipart/form-data">
                                    @csrf
