@extends('admin.layout',[ 'title' => __($title ?? 'Danh sách bài viết')])
@section('main')
                                    ...
                                    <div class="toggle-expand-content" data-content="pageMenu">
                                        <ul class="nk-block-tools g-3">
                                            ...
                                            <li class="nk-block-tools-opt">
                                                ...
                                                <a href="{{route('admin.posts.create')}}" class="btn btn-primary d-none d-md-inline-flex"><em class="icon ni ni-plus"></em><span>Tạo bài viết</span></a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
