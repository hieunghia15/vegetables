@extends('admin.layout',[ 'title' => __($title ?? 'Bài viết bị báo cáo')])
@section('main')
                    ...
                    <div class="nk-block-between">
                        <div class="nk-block-head-content">
                            <h3 class="nk-block-title page-title">
                                ...
                                <span><a href="" class="active">Bài viết bị báo cáo</a></span>
                            </h3>
                        </div>
                        <div class="nk-block-head-content">
                    ...
                    <div class="nk-tb-list is-separate is-medium mb-3">
                        ...
                        <div class="nk-tb-item">
                            ...
                            <div class="nk-tb-col">
                                ...
                                <span class="badge badge-sm badge-dot has-bg badge-warning d-none d-mb-inline-flex">Báo cáo</span>
                            </div>
