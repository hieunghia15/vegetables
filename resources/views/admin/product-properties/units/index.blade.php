@extends('admin.layout' , [ 'title' => __($title ?? 'Đơn vị')])
@section('main')
            ...
            <div class="nk-content-body">
                    ...
                    <div class="nk-block-between">
                        <div class="nk-block-head-content">
                            <h3 class="nk-block-title page-title">
                                ...
                                <span><a href="" class="active">Đơn vị</a></span>
                            </h3>
                        </div>
                        <div class="nk-block-head-content">
                                ...
                                <div class="toggle-expand-content" data-content="pageMenu">
                                    <ul class="nk-block-tools g-3">
                                        ...
                                        <li class="nk-block-tools-opt">
                                            ...
                                            <a href="{{route('admin.units.create')}}" data-target="addProduct"
                                                class="toggle btn btn-primary d-none d-md-inline-flex"><em
                                                    class="icon ni ni-plus"></em><span>Thêm đơn vị</span></a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                ...
                <div class="nk-block">
                    <div class="nk-tb-list is-separate is-medium mb-3">
                        ...
                        <div class="nk-tb-item nk-tb-head">
                            ...
                            <div class="nk-tb-col tb-col-md"><span>Đơn vị</span></div>
                        ...
                        <div class="nk-tb-item">
                            ...
                            <div class="nk-tb-col">
                                <span class="tb-lead">{{$unit->id}}</></span>
                            </div>
                            <div class="nk-tb-col tb-col-md">
                                <span class="tb-sub">{{$unit->name}}</span>
                            </div>
                            <div class="nk-tb-col nk-tb-col-tools">
                                    ...
                                    <li>
                                        <div class="drodown mr-n1">
                                            ...
                                            <ul class="link-list-opt no-bdr">
                                                    <li><a href="{{route('admin.units.edit',$unit->id)}}"><em class="icon ni ni-edit"></em><span>Chỉnh sửa</span></a></li>

                                                    <li><a href="{{route('admin.units.delete',$unit->id)}}"><em class="icon ni ni-trash"></em><span>Xóa</span></a></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </li>
                ...
                <div class="nk-add-product toggle-slide toggle-slide-right" data-content="addProduct"
                    ...
                    <div class="nk-block-head">
                        <div class="nk-block-head-content">
                            <h5 class="nk-block-title">Thêm đơn vị</h5>
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    <label class="form-label" for="product-title">Đơn vị</label>
                                    <div class="form-control-wrap">
