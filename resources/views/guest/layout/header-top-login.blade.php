...
<div class="header__top header-border">
    <div class="ml-5 mr-5">
        <div class="row">
            <div class="col-lg-4">
                <div class="header__top__left">
                    <ul>
                        <li><i class="fa-solid fa-users"></i>&ensp;
                            @if(Auth()->user()->roles->first()->name == 'farmer')
                            <a href="{{route('guest.seller.index',Auth()->user()->farmer->id)}}" class="text-link">Kênh người bán |</a>
                            <a href="{{route('admin.index')}}" class="text-link">Quản lý</a>
                            @elseif(Auth()->user()->roles->first()->name == 'customer')
                            <a href="{{route('customer.user.register-seller')}}" class="text-link">
                                Trở thành người bán</b>
                            </a>
                            @else
                            <b class="text-grey">111</b>
                            @endif
                        </li>
                ...
                <div class="header__top__right">
                    ...
                    <div class="header__top__right__auth">
                        ...
                        <ul class="noidung_dropdown list-unstyled">
                            <li>
                                <a href="{{route('customer.user.profile')}}">Tài khoản của tôi</a>
                            </li>
                            <li>
