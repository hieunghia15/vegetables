                ...
                <div class="post-tag">
                    ...
                    <span class="pr-5">
                        <button class="post-btn"
                            onclick="location.href='{{route('guest.news.category-post',$category->category_slug)}}'">{{ $category->name }}</button>
                    </span>
                    @endforeach
                </div>
            </div>
                    ...
                    <div class="blog__sidebar">
                        ...
                        <div class="blog__sidebar__item">
                            ...
                            <ul>
                                ...
                                @foreach ($categories as $category)
                                <li><a
                                        href="{{route('guest.news.category-post',$category->category_slug)}}">{{ $category->name }}</a>
                                </li>
                                @endforeach
                            </ul>
                        </div>
