                ...
                <div class="col-lg-12">
                    <div class="blog__details__hero__text">
                        <ul>
                            ...
                            <li><a href="{{ route('guest.blogs.category-post', $posts->category->category_slug) }}">{{ $posts->category->name }}</a></li>
                ...
                <div class="col-lg-8 col-md-7 shadow">
                    <div class="row pt-5 pl-3 pr-3">
                        <div class="blog__details__text">
                            ...
                            <center><small class="pb-3">{{ $posts->postBy->name }} &ndash;
                                    {{ Carbon\Carbon::parse($posts->created_at)->format('d-m-Y') }}</small></center>
                            {!! $posts->content !!}
                        </div>
                    </div>
