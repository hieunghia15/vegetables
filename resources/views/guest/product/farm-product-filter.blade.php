                        ...
                        <div class="sidebar__item">
                            ...
                            <form action ="{{route('guest.product.filter')}}" >
                                    <ul>    
                                            ...
                                            <li>
                                                <input type="checkbox" name="type[]" value="{{$productType->id}}" />&emsp;{{$productType->name}}
                                            </li>
                                            @endforeach
                                        </ul>
                                    </div>
                                    <div class="sidebar__item">
                                        ...
                                        <ul>
                                            <li><input type="checkbox" name="province[]" value="{{$province->id}}" />&emsp;{{$province->name}}</li>
                                    ...
                                    <div class="sidebar__item">
                                        <h4>Khoảng giá</h4>
                                            <div class="pb-2">
                                                <input type="text" class="col-4" name="top_level" placeholder=" 0đ">&ensp;&ndash;&ensp;
                                        ...
                                        <a href="#" class="latest-product__item">
                                            <div class="latest-product__item__pic">
                                                <img src="../{{$product->thumbnail}}"
                                                    alt="{{$product->name}}" class="img-new-pro">
                                            </div>
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-6">
                            <div class="featured__item shadow">
                                <div class="featured__item__pic">
                                    <img src="../{{$product->thumbnail}}" alt="{{$product->name}}" class="img-pro">
                                    <ul class="featured__item__pic__hover">
                                        <li><a href=""><i class="fa fa-heart"></i></a></li>
                                        <li><a href=""><i class="fa fa-retweet"></i></a></li>
                                        <li><a href="{{route('customer.cart.addcart',$product->id)}}"><i class="fa fa-shopping-cart"></i></a></li>
                                    </ul>
                                </div>
                                <div class="featured__item__text">
                                    <h6><a href="{{route('guest.product.productdetail',$product->product_slug)}}" name="product_name[]" value="{{$product->name}}"><b>{{$product->name}}</b></a>
                                    </h6>
                                    
                                    <div class="check-in">
                                        <span><i class="fa-solid fa-location-dot"></i>&ensp;{{$product->farmer->user->ward->district->province->name}}</span>
                                    </div>
                                   
                                    <h5 class="price">
                                        <a href="" name="product_price[]" class="text-dark">{{$product->price}}</a>
                                        <sup>đ</sup>/{{$product->pack}}
